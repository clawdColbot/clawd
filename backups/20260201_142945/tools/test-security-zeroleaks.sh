...
echo "╔════════════════════════════════════════════════════════════╗"
echo "║     🔒 ZeroLeaks - Security Testing Setup                  ║"
echo "╚════════════════════════════════════════════════════════════╝"
echo ""

echo "📋 CHECKLIST PARA PROBAR ZEROLEAKS"
echo "════════════════════════════════════════════════════════════"
echo ""
...
echo "4. 📊 EVALUACIÓN DE RESULTADOS"
echo "   ─────────────────────────────────────────"
echo "   # Preguntas a responder:"
echo "   - ¿Encontró vulnerabilidades reales?"
echo "   - ¿Son actionable los findings?"
echo "   - ¿Cuántos tokens consumió el scan?"
echo "   - ¿Falsos positivos vs vulnerabilidades reales?"
echo ""
...
echo "   - No es sustituto de buenas prácticas de seguridad"
echo ""
echo "📚 DOCUMENTACIÓN:"
echo "   - ~/clawd/docs/ZEROLEAKS_ANALYSIS.md"
echo "   - https://github.com/ZeroLeaks/zeroleaks"
echo ""
echo "🦊 Recomendación: Probar esta semana y evaluar"
echo ""
